...
namespace WindowsFormsApplication1
{
    ...
    class NebeskoTeloV2
    {
        ...
        public string name;
        private bool osenceno_planeta;
        private bool osenceno_or;
        ...
        */
        ...
        public NebeskoTeloV2(string _name, double Mass_Of_The_Body,
            ...
            double Circumference_of_the_planet, NebeskoTeloV2 neb, int Rgb_Red, int Rgb_Green, int Rgb_Blue)
        {
            alfa = X_Ofset;
            mass = Mass_Of_The_Body;
            semi_major = Semi_Major_Axis_of_Orbit;
            ...
            gr = Rgb_Green;
            bl = Rgb_Blue;
            pla_boj = new SolidBrush(Color.FromArgb(Rgb_Red, Rgb_Green, Rgb_Blue));
            or_boj = new Pen(Color.FromArgb(Rgb_Red, Rgb_Green, Rgb_Blue),1);
            parent = neb;
            name = _name;
        }
        public void Cursor_Plan(double mis_x, double mis_y)
        {
                ...
                (mis_y >= tilted_y - pla_r_calc(pla_r) && mis_y <= tilted_y + pla_r_calc(pla_r)))
            {
                ...
                pla_boj = new SolidBrush(Color.FromArgb((int)(re * 0.5), (int)(gr * 0.5), (int)(bl * 0.5)));
            }
            else
            {
                pla_boj = new SolidBrush(Color.FromArgb(re, gr, bl));
        ...
        public virtual void Cursor_Or(double mis_x, double mis_y)
        {
            ...
            {
                osenceno_or = true;
                or_boj = new Pen(Color.FromArgb((int)(re * 0.5), (int)(gr * 0.5), (int)(bl * 0.5)), 2);
            }
            else
            {
                or_boj = new Pen(Color.FromArgb(re, gr, bl), 1);
                osenceno_or = false;
        ...
        public void DrawOrbit(Graphics a)
        {
            ...
            while (i < k)
            {
                ...
                a.DrawLine(or_boj, (float)x_1, (float)y_1, (float)x_2, (float)y_2);
                x_1 = x_2;
                y_1 = y_2;
            }
