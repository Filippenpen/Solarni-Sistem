...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load_1(object sender, EventArgs e)
        {
            ...
            sun = new Sun(10, 1000, 255, 50, 50);
            tela.Add(sun);
            tela.Add(new NebeskoTeloV2("Body1",100, 300, 0.5, 20, 5, tela[0], 200, 50, 50));
            //tela.Add(new NebeskoTeloV2(100, 300, 0.5, 20, 5, pronadji(tela, "sunce"), 50, 50, 50));
            tela.Add(new NebeskoTeloV2("Body2",23, 75, 0.5, 20, 5, tela[1], 50, 200, 50));
       ...
       */
        ...
        {
            foreach (NebeskoTeloV2 neb in tela) {
                comboBox1.Items.Add(neb.getName());
            }
