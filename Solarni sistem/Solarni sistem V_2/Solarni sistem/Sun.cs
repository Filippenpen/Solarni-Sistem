...

{
    class Sun : NebeskoTeloV2
    {
        ...
        public Sun( double _r, double _mass, int Rgb_Red, int Rgb_Green, int Rgb_Blue) 
            : base("Sun",_mass, 0, 0, 0, _r, null, Rgb_Red, Rgb_Green, Rgb_Blue)
        {
        ...
        {
            a.FillEllipse(pla_boj, (float)(Sun_x - pla_r_calc(pla_r)), (float)(Sun_y - pla_r_calc(pla_r)), (float)(2 * pla_r_calc(pla_r)), (float)(2 * pla_r_calc(pla_r)));
            DrawName(a);
